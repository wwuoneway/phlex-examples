...
//--------------------------
  ...
  PeakFitterMrqdt::PeakFitterMrqdt(const PeakFitterMrqdtCfg& cfg)
    : fMinWidth(cfg.fMinWidth)
    , fMaxWidthMult(cfg.fMaxWidthMult)
    , fPeakRange(cfg.fPeakRange)
    , fAmpRange(cfg.fAmpRange) {}
