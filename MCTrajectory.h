// Header for MCTrajectory from nutools simplified for testing Phlex and FORM.  Original Header by Brian Rebel in 2012.  Simplification by Andrew Olivier and Peter van Gemmeren in 2025. 
...
inline simb::MCTrajectory::const_iterator simb::MCTrajectory::begin() const
{
  return ftrajectory.begin();
}
inline simb::MCTrajectory::iterator simb::MCTrajectory::end() { return ftrajectory.end(); }
inline simb::MCTrajectory::const_iterator simb::MCTrajectory::end() const
{
  return ftrajectory.end();
}
inline simb::MCTrajectory::reverse_iterator simb::MCTrajectory::rbegin()
{
  return ftrajectory.rbegin();
}
inline simb::MCTrajectory::const_reverse_iterator simb::MCTrajectory::rbegin() const
{
  return ftrajectory.rbegin();
}
inline simb::MCTrajectory::reverse_iterator simb::MCTrajectory::rend()
{
  return ftrajectory.rend();
}
inline simb::MCTrajectory::const_reverse_iterator simb::MCTrajectory::rend() const
{
  return ftrajectory.rend();
}
...
inline const simb::MCTrajectory::value_type& simb::MCTrajectory::operator[](
  const simb::MCTrajectory::size_type i) const
{
  return ftrajectory[i];
}

inline const simb::MCTrajectory::value_type& simb::MCTrajectory::at(
  const simb::MCTrajectory::size_type i) const
{
...
inline void simb::MCTrajectory::push_back(const TLorentzVector& p, const TLorentzVector& m)
{
  ftrajectory.push_back(simb::MCTrajectory::value_type(p, m));
}

inline void simb::MCTrajectory::Add(const TLorentzVector& p, const TLorentzVector& m)
{
  push_back(p, m);
}

inline simb::MCTrajectory::ProcessMap const& simb::MCTrajectory::TrajectoryProcesses() const
{
